...
from src.thriller.reverse_attack import reverse_sentences
from src.thriller.reverse_attack import reverse_words
from src.thriller.sarcasm_attack import sarcasm
...
def generate_experiment_texts(experiment_config: dict[str, str]):
    ...
    if sentences:
        ...
        texts = {
            "Experiment A": [
                ("Pen Not Mentioned", reverse_sentences([experiment_A_pen_not_mentioned])),
                ("Pen Mentioned Removed", reverse_sentences([experiment_A_pen_mentioned_removed])),
                ("Pen Mentioned Not Removed", reverse_sentences([experiment_A_pen_mentioned_not_removed])),
            ],
            "Experiment B": [
                ("Unused Comb", reverse_sentences([experiment_B_unused_comb])),
                ("Used Comb", reverse_sentences([experiment_B_used_comb])),
            ],
            "Experiment C": [
                ("Prior Solution Not Mentioned", reverse_sentences([experiment_C_prior_solution_not_mentioned])),
                (
                    "Prior Solution Mentioned and Removed",
                    reverse_sentences([experiment_C_prior_solution_mentioned_and_removed]),
                ),
                (
                    "Prior Solution Mentioned Not Removed",
                    reverse_sentences([experiment_C_prior_solution_mentioned_not_removed]),
                ),
            ],
                }
        print(texts)
    if words:
        ...
        texts = {
            "Experiment A": [
                ("Pen Not Mentioned", reverse_words([experiment_A_pen_not_mentioned])),
                ("Pen Mentioned Removed", reverse_words([experiment_A_pen_mentioned_removed])),
                ("Pen Mentioned Not Removed", reverse_words([experiment_A_pen_mentioned_not_removed])),
            ],
            "Experiment B": [
                ("Unused Comb", reverse_words([experiment_B_unused_comb])),
                ("Used Comb", reverse_words([experiment_B_used_comb])),
            ],
            "Experiment C": [
                ("Prior Solution Not Mentioned", reverse_words([experiment_C_prior_solution_not_mentioned])),
                (
                    "Prior Solution Mentioned and Removed",
                    reverse_words([experiment_C_prior_solution_mentioned_and_removed]),
                ),
                (
                    "Prior Solution Mentioned Not Removed",
                    reverse_words([experiment_C_prior_solution_mentioned_not_removed]),
                ),
            ],
                }
        print(texts)
    ...
    if spongebob:
        print("running \"SaRcAsM\"")
        texts = {
            "Experiment A": [
                ("Pen Not Mentioned", sarcasm([experiment_A_pen_not_mentioned])),
                ("Pen Mentioned Removed", sarcasm([experiment_A_pen_mentioned_removed])),
                ("Pen Mentioned Not Removed", sarcasm([experiment_A_pen_mentioned_not_removed])),
            ],
            "Experiment B": [
                ("Unused Comb", sarcasm([experiment_B_unused_comb])),
                ("Used Comb", sarcasm([experiment_B_used_comb])),
            ],
            "Experiment C": [
                ("Prior Solution Not Mentioned", sarcasm([experiment_C_prior_solution_not_mentioned])),
                (
                    "Prior Solution Mentioned and Removed",
                    sarcasm([experiment_C_prior_solution_mentioned_and_removed]),
                ),
                (
                    "Prior Solution Mentioned Not Removed",
                    sarcasm([experiment_C_prior_solution_mentioned_not_removed]),
                ),
            ],
                }
        print(texts)
